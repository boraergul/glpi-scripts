...
GUI'nin kullandığı sunucu profil dosyasıdır. Artık kök dizindeki `config/servers.json` konumunda tutulmaktadır. Aynı `servers.json` dosyası `templates_export_import/` modülüyle paylaşılabilir.
